...
urlpatterns = [
    ...
    path('payment/success/', views.TemplateView.as_view(template_name="payment_success.html"), name="payment-success"),
    path('payment/error/', views.TemplateView.as_view(template_name="payment_error.html"), name="payment-error"),
]